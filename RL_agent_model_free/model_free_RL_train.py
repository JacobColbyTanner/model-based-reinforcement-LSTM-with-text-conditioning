...
class GymAgent:
    ...
    def train(self, max_runs_reward, file_path):
    ...
    def collect_data(self,file_path,num_images,image_size_rows, file_path_save):
        ...
        #save array
        np.save(file_path_save, states_actions_rewards)
